...
import com.liferay.product.navigation.site.administration.util.LatentGroupManager;
...
public class SiteAdministrationPanelCategoryDisplayContext {
	...
	public Group getGroup() {
		...
		Group latentGroup = LatentGroupManager.getLatentGroup(session);
		...
		if (_group.isControlPanel()) {
			...
			LatentGroupManager.setLatentGroup(session, _group);
		}
